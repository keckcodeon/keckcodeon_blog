...
```{r remedy03, echo = F, fig.align = 'center'}
...
```{r remedy04, echo = F, fig.align = 'center'}
...
```{r remedy35, echo = FALSE, out.width="400px", fig.align="center"}
...
```{r remedy64, echo = FALSE, fig.cap = "Query and Subject Ranges", message = FALSE}
library(ggplot2)
...
```{r remedy65, echo = FALSE, out.width="600px"}
...
```{r remedy67, echo = FALSE, fig.cap="Intersect Join"}
...
```{r remedy69, echo = FALSE, fig.cap = "Inner Join", message = FALSE}
...
```{r remedy71, echo = FALSE, out.width="600px"}
